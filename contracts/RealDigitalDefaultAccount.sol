...
// File: contracts/CBDCAccessControl.sol
...
// File: contracts/RealDigital.sol
...
// File: contracts/RealDigitalDefaultAccount.sol
...
contract RealDigitalDefaultAccount is CBDCAccessControl {
    ...
    /// @param _authority The address of the authority role.
    /// @param _admin The address of the admin role.
    constructor(RealDigital token, address _authority, address _admin) CBDCAccessControl(_authority, _admin) {
        realDigital = token;
    }
    ...
    function addDefaultAccount(uint256 cnpj8, address wallet) public onlyRole(ACCESS_ROLE) {
        require(defaultAccount[cnpj8] == address(0), "RealDigitalDefaultAccount: Default account already set");
    ...
    function updateDefaultWallet(uint256 cnpj8, address newWallet) public onlyRole(ACCESS_ROLE) {
        require(defaultAccount[cnpj8] != address(0), "RealDigitalDefaultAccount: Default account not set");
